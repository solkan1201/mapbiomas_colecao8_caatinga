...
var param = { 
    ...
    asset_filted : {
            'V3':'projects/mapbiomas-workspace/AMOSTRAS/col8/CAATINGA/CLASS/ClassCol8V3',
...
var imgMapCol8V3 =  ee.ImageCollection(param.asset_filted.V3).filter(ee.Filter.eq('id_bacia', selBacia)).first();
imgMapCol8V3 = imgMapCol8V3.select(banda_activa).remap(param.classMapB, param.classNew);

var imgMapCol8V4 =  ee.ImageCollection(param.asset_filted.V4).filter(ee.Filter.eq('id_bacia', selBacia)).first();
imgMapCol8V4 = imgMapCol8V4.select(banda_activa).remap(param.classMapB, param.classNew);
...
var imgMapCol8V6 =  ee.ImageCollection(param.asset_filted.V6).filter(ee.Filter.eq('id_bacia', selBacia)).first();
imgMapCol8V6 = imgMapCol8V6.select(banda_activa).remap(param.classMapB, param.classNew);

// var imgMapCol8V7 =  ee.ImageCollection(param.asset_filted.V7) .filter(ee.Filter.eq('id_bacia', selBacia)).first();
// imgMapCol8V7 = imgMapCol8V7.select(banda_activa).remap(param.classMapB, param.classNew);

// var imgMapCol8V9 =  ee.ImageCollection(param.asset_filted.V9).filter(ee.Filter.eq('id_bacia', selBacia)).first();
// imgMapCol8V9 = imgMapCol8V9.select(banda_activa).remap(param.classMapB, param.classNew);
...
Map.addLayer(imgMapCol8V3,  visualizar.visclassCC, 'Col8_ClassV3', false);
Map.addLayer(imgMapCol8V4,  visualizar.visclassCC, 'Col8_ClassV4', false);
Map.addLayer(imgMapCol8V5,  visualizar.visclassCC, 'Col8_ClassV5', false);
Map.addLayer(imgMapCol8V6,  visualizar.visclassCC, 'Col8_ClassV6', false);
// Map.addLayer(imgMapCol8V7,  visualizar.visclassCC, 'Col8_ClassV8');
// Map.addLayer(imgMapCol8V9,  visualizar.visclassCC, 'Col8_ClassV9');
